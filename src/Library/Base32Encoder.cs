// Base32Encoder sources from http://scottless.com/blog/archive/2014/02/15/base32-encoder-and-decoder-in-c.aspx
// Useful base32 encoding reference http://www.herongyang.com/Encoding/Base32-Encoding-Algorithm.html
// Licenced using Creative Commons 2 Attribution Licence https://creativecommons.org/licenses/by/2.0/legalcode
...
namespace Library
{
    ...
    public sealed class Base32Encoder
    {
        ...
        private const int PaddedGroupSize = 8;
        ...
        public static string? ToBase32String(byte[] bytes)
        {
            ...
            // Add padding
            var remainder = builder.Length % PaddedGroupSize;
            if (remainder > 0)
            {
                builder.Append(PaddingCharacter, PaddedGroupSize - remainder);
            }
        ...
        public static byte[]? FromBase32String(string base32String)
        {
            ...
            var base32StringTrimmed = base32String.TrimEnd(PaddingCharacter);

            // Convert to upper-case
            string base32StringUpperCase = base32StringTrimmed.ToUpperInvariant();
